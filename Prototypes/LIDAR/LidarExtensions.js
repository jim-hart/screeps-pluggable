/**
 * This is an exact copy of LidarOverloaded, except the method names don't
 * overload the API names.  These can be used safely along side existing API
 * methods without any conflict
 */
'use strict';
 ...
 *                                               else false
 */
RoomPosition.prototype.isSameAs = function(arg1, arg2) {
 ...
 */
RoomPosition.prototype.isCloseTo = function(arg1, arg2) {
    const type = typeof arg1;
    if (type === 'number') {
        arg2 = typeof arg2 === 'number' ? arg2 : undefined;
 ...
 */
RoomPosition.prototype.inDistanceTo = function(arg1, arg2, arg3) {
    const type = typeof arg1;
    if (type === 'number') {
        arg2 = typeof arg2 === 'number' ? arg2 : undefined;
 ...
 */
RoomPosition.prototype.getDistanceTo = function(arg1, arg2) {
    const type = typeof arg1;
    if (type === 'number') {
        arg2 = typeof arg2 === 'number' ? arg2 : undefined;
 ...
 */
RoomPosition.prototype.getHeadinmgTo = function(arg1, arg2) {
    const type = typeof arg1;
    if (type === 'number') {
